					...
					<div className="flex items-center justify-between w-full">
						...
						<div className="w-1/2 flex flex-col items-center self-center">
							...
							<div className="flex items-center self-start mt-2 ">
								<Link
									className="bg-dark text-light rounded-lg text-lg font-semibold hover:bg-light hover:text-dark transition-all border-solid hover:border-dark p-2.5 px-6 border-2  flex items-center"
									target={"_blank"}
									href="/resume.pdf"
									download={true}
								>
								...
								<Link
									className="ml-4 text-lg font-medium capitalize text-dark underline underline-offset-2 transition-all"
									target={"_blank"}
